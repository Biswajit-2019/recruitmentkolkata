                ...
                <div class="right-section">
                    ...
                    <div class="content-text">
                        ...
                        <div class="recruitment-box">
                            ...
                            <h4>Download :  <a href="<?=$download;?>" target="_blank"><u>Vacancy Details</u></a></h4>
                           <!--  <h4>Apply online :  <a href="<?=base_url('login');?>"><u>http://kolkata.sameer.gov.in /recruitment</u></a></h4> -->


                             <?php $guidelines = (is_file(FCPATH.'/'.$value->guideline))?base_url().$value->guideline:'' ?>
                             <?php if($value->guideline_status==1){ ?>
                                <br>
                            <h4><a href="<?=$guidelines;?>" target="_blank">Guidelines for Online Examination</a></h4>
                        <?php } ?>
