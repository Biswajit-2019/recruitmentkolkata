        	...
        	<div class="status-box">
                <div class="status-cont">
                     ...
                     ?> 
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><strong><?=$value->advertise_id?></strong></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><?=($single_personal_data)?$single_personal_data->user_name:''?></td>
                            </tr>
                            <tr>
                                <td>Email ID:</td>
                                <td><?=($this->session->userdata('email'))?$this->session->userdata('email'):''?></td>
                            </tr>
                            <tr>
                                <td>Date:</td>
                            ...
                            <tr>
                                ...
                                <td><?=($single_personal_data)?$single_personal_data->post_for:''?></td>
                            </tr>
                        </table>
                        ...
                        <ul class="probar">
                            ...
                            <li class="<?=($value->application_status==3)?'':'disabled'?>">Selected for Interview<?=($value->application_status==3)?'<span class="date">Date: '.date("d-m-Y", strtotime($value->interview_date)).'</span>':''?></li>                           
                        </ul>
                        <div class="note-sec">
                    ...
                    <?php } ?>
                     ...
                     <?php if(!empty($application)){ ?>
                     <div class="status-footer">If you are selected, official Email / postal letter will be sent</div>
                <?php } ?>
                </div>
            </div>
        </div>
