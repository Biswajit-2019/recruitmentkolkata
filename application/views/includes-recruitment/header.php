            ...
            <div class="mid-header">
                ...
                <div class="top-header">
                    <div class="container">
                        <ul class="access-option">
                            <li><a href="<?php echo main_base_url;?>/accessibility-options">Accessibility option</a></li>
                            <li><a href="<?php echo main_base_url;?>/site-map">Site Map</a></li>
                        </ul>
                    </div>
                </div>
            
                <div class="logo">
                    <a href="<?php echo main_base_url;?>"><img src="<?php echo base_url(); echo IMAGE_URL;?>logo.png" alt=""></a>
                    ...
                    <div class="mobile-nav2">
                        ...
                        foreach($cms as $cmsValue){ 
                             $url1 = ($cmsValue->id==21)?recruitment_base_url:main_base_url;
                            ?>                          
                        <li>
                             <a href="<?php echo $url1.'/'.$cmsValue->slug;?>"><?php echo $cmsValue->page_title;?></a>
                    ...
                    <?php foreach ($data as $subValue){  
                               ...
                               $datasubsub=$this->Common_model->getData('cms_pages',$paramsubsub);?>
                                <li <?php if(!empty($datasubsub)){echo "class='sub-menu'";}?>><a href="<?php echo main_base_url.'/'; echo $subValue->slug;?>"><?php echo $subValue->page_title;?></a> 
                              <?php if(!empty($datasubsub))
                               {?>
                                <ul>
                                <?php foreach($datasubsub as $datasubsubval){?>
                                 <li><a href="<?php echo main_base_url.'/'; echo $datasubsubval->slug;?>"><?php echo $datasubsubval->page_title;?></a></li>
                              <?php   } ?>
                                </ul>
                             <?php   }  ?>
                ...
                <div class="header-right">
                    <div class="right-top">
                        ...
                        <div class="hindi hindi-ver"><a href="<?php echo main_base_url;?>/hindi">हिंदी</a></div>
                    </div>
                ...
                <div class="top-navbar">   <!--navbar start-->
                    <div class="container">
                        <nav>
                            <ul>
                                <li><a href="<?php echo main_base_url;?>">Home</a></li>
                        <?php 
                        if(!empty($cms)){
                        foreach($cms as $cmsValue){ 
                        $param=array('parent_id'=>$cmsValue->id);
                        $data=$this->Common_model->getData('cms_pages',$param);?>
                         <li <?php if(!empty($data)){echo "class='parent-menu'";}?> >
                            <?php $url = ($cmsValue->id==21)?recruitment_base_url:main_base_url?>
                            <a  href="<?php if(!empty($data)){echo "javascript:void(0);";} else {echo $url.'/'; echo $cmsValue->slug;}?>"><?php echo $cmsValue->page_title;?></a>
                        <?php if(!empty($data))
                        { ?>
                        <ul>
                    <?php foreach ($data as $subValue){  
                               $paramsubsub=array('parent_id'=>$subValue->id);
                               $datasubsub=$this->Common_model->getData('cms_pages',$paramsubsub);?>
                                <li <?php if(!empty($datasubsub)){echo "class='sub-menu'";}?>>
                                    <a href="<?php if(!empty($datasubsub)){echo "javascript:void(0);";} else {echo main_base_url.'/'; echo $subValue->slug;}?>"><?php echo $subValue->page_title;?></a> 
                              <?php if(!empty($datasubsub))
                               {?>
                                <ul>
                                <?php foreach($datasubsub as $datasubsubval){?>
