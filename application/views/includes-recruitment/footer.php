            ...
            <div class="footer-bg">
                <ul>
                    <?php if(!empty($footer)){
                        ...
                        ?>
                    <li><a href="<?php echo main_base_url; echo '/'.$footerVal->slug;?>"><?php echo $footerVal->page_title;?></a></li>
                    <?php } }?>
                  <li><a href="<?php echo main_base_url;?>feed-back">Feedback</a></li>
                </ul>
...
<script src="<?php echo base_url(); echo JS_URL;?>custom.js"></script>
