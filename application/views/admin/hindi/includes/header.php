...
<header>
  <div class="wrapper">
    <div class="logo"><a href="<?php echo base_url();?>admin/hindi/dashboard" title="Sameer Kolkata"><img src="<?php echo base_url();echo admin_IMAGE_URL;?>logo.png" width="120" height="66" alt="Sameer Kolkata"/></a></div>
    <div class="hd_rt">
      <?php //echo  $pageTitle; ?>
    </div>
    ...
    <nav>
      <select name="select" id="select" ONCHANGE="location = this.options[this.selectedIndex].value;">
        <option value="<?php echo base_url();?>admin/hindi/dashboard">Home</option>
        <option value="<?php echo base_url();?>admin/hindi/logout">Logout</option>
      </select>
      ...
      <ul>
        <li  <?php if($link=='home.php'){ ?> class="selected" <?php } ?>><span><a href="<?php echo base_url();?>admin/hindi/dashboard" class="home-icon">Home</a></span></li>
        <li  <?php if($link=='logout.php'){ ?> class="selected" <?php } ?>><span><a href="<?php echo base_url();?>admin/hindi/logout" class="logout-icon">Logout</a></span></li>
      </ul>
    </nav>
  </div>
</header>
