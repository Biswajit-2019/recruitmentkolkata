...
<?php echo form_open_multipart('admin/hindi/cms-page/editcms',array('id'=>'advert_frm'));?>

<table  class="formRight ckedit" id="tableForm"><tr><th colspan="2" class="add-menu"> Edit CMS Page</th>
