<script type="text/javascript">
  ...
  $("#advert_frm").validate({
      rules: {
          pageurl: {
          required: true,
          remote : "<?php echo base_url();?>admin/ajax_controller/check_advert_title"
        },
        title:{
          required: true  
        }
...
<?php echo form_open_multipart('admin/cms-page/add-cms',array('id'=>'advert_frm'));?>
...
<td width="240">
<input type="text" name="pageurl" data-allowed-chars="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXY Z" data-messageid="input-error" onkeypress=""  />
 <span id="input-error" style="color:red;visibility:hidden; width: 58%; float:right; margin-top:-40px;">Please enter Alphabet only</span>
</td>
</tr>
