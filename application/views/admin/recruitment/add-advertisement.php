    ...
    $(document).ready(function(){
        $("#advertisement_form").validate({
          rules: {
              advtNo: {
              required: true,
              remote : "<?php echo base_url();?>admin/ajax_controller/check_advt_no"
            },
            date:{
              required: true  
            },
...
<?php echo form_open_multipart('admin/advertisement/add',array('id'=>'advertisement_form'));?>
...
<tr>
    ...
    <!-- <td width="240">
        <textarea name="vacancyDescription"><?= set_value('vacancyDescription'); ?></textarea>
    </td> -->
</tr>
<tr>
    <td width="61" align="right">
