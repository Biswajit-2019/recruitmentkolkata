            ...
            <div class="mid-header">
                ...
                <div class="logo">
                    ...
                    <div class="mobile-nav2">
                        ...
                        <li><a href="<?php if($cmsValue->content!=''){echo base_url(); echo $cmsValue->slug;} else { ?>javascript:void(0); <?php }?>"><?php echo $cmsValue->page_title;?></a>
                ...
                <div class="top-navbar">   <!--navbar start-->
                    <div class="container">
                        ...
                        $data=$this->Common_model->getData('cms_pages',$param);?>
                         <li <?php if(!empty($data)){echo "class='parent-menu'";}?> ><a  href="<?php if(!empty($data)){echo "javascript:void(0);";} else {echo base_url(); echo $cmsValue->slug;}?>"><?php echo $cmsValue->page_title;?></a>
                        <?php if(!empty($data))
                        { ?>
                        <ul>
                    <?php foreach ($data as $subValue){  
                               $paramsubsub=array('parent_id'=>$subValue->id);
                               $datasubsub=$this->Common_model->getData('cms_pages',$paramsubsub);?>
                                <li <?php if(!empty($datasubsub)){echo "class='sub-menu'";}?>><a href="<?php if(!empty($datasubsub)){echo "javascript:void(0);";} else {echo base_url(); echo $subValue->slug;}?>"><?php echo $subValue->page_title;?></a> 
                              <?php if(!empty($datasubsub))
                               {?>
                                <ul>
                                <?php foreach($datasubsub as $datasubsubval){?>
