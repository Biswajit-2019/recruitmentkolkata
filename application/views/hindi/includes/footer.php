            ...
            <div class="footer-bg">
                <ul>
                   <?php if(!empty($footer)){
                        ...
                        ?>
					 <li><a href="<?php echo base_url();?>hindi/<?php echo $footerVal->slug;?>"><?php echo $footerVal->page_title;?></a></li>
                    <?php } }?>

					 <li><a href="<?php echo base_url();?>hindi/feed-back">प्रतिक्रिया</a></li>
