    	...
    	<div class="container">
            ...
            ?>
                ...
                <div class="right-section variable_font">
                	<h1>प्रतिक्रिया <span class="print"><a href="javascript:void(0);"  title="Print" class="print-btn">Print</a></span></h1>
                    <div class="content-text security-en">
