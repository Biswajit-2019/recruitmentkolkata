        	...
        	<div class="mid-header">
            	...
            	<div class="top-header">
                    <div class="container">
                        <ul class="access-option">
                            <li><a href="<?php echo main_base_url;?>/hindi/accessibility-options">एक्सेसिबिलिटी विकल्प </a></li>
                            <li><a href="<?php echo main_base_url;?>/hindi/site-map">साइटमैप</a></li>
                        </ul>
                    </div>
                </div>
            
            	<div class="logo">
                	<a href="<?php echo main_base_url;?>/hindi"><img src="<?php echo base_url(); echo IMAGE_URL;?>logo.png" alt=""></a>
                    ...
                    <div class="mobile-nav2">
                        ...
                        foreach($cms as $cmsValue){ 
                             $url1 = ($cmsValue->id==46)?recruitment_base_url:main_base_url;
                            ?>
                        <li><a href="<?php echo $url1.'/';?>hindi/<?php echo $cmsValue->slug;?>"><?php echo $cmsValue->page_title;?></a>
                    ...
                    <?php foreach ($data as $subValue){  ?>
                            <li><a href="<?php echo main_base_url;?>/hindi/<?php echo $subValue->slug;?>"><?php echo $subValue->page_title;?></a> </li>
                       <?php  }?>
                       </ul>
                       <?php  } ?>
                ...
                <div class="header-right">
                	<div class="right-top">
                        ...
                        <div class="hindi-ver"><a href="<?php echo main_base_url;?>">English</a></div>
					</div>
                ...
                <div class="top-navbar">   <!--navbar start-->
                    <div class="container">
                        <nav>
                            <ul>
                                <li><a href="<?php echo main_base_url;?>/hindi">मुख पृष्ठ </a></li>
                             <?php  if(!empty($cms)){
                        foreach($cms as $cmsValue){
                        $param=array('parent_id'=>$cmsValue->id);
                        $data=$this->Common_model->getData('hindi_cms_pages',$param);?>
                        <?php $url = ($cmsValue->id==46)?recruitment_base_url:main_base_url?>
                        <li <?php if(!empty($data)){echo "class='parent-menu'";}?>><a href="<?php if(!empty($data)){echo "javascript:void(0);";} else { echo $url.'/';?>hindi/<?php echo $cmsValue->slug;}?>"><?php echo $cmsValue->page_title;?></a>
                       <?php  if(!empty($data))
                        { ?>
                        <ul>
                    <?php foreach ($data as $subValue){  ?>
                               ...
                               $datasubsub=$this->Common_model->getData('hindi_cms_pages',$paramsubsub);?>
                                 <li <?php if(!empty($datasubsub)){echo "class='sub-menu'";}?>><a href="<?php if(!empty($datasubsub)){echo "javascript:void(0);";} else {echo main_base_url.'/';?>hindi/<?php echo $subValue->slug;}?>"><?php echo $subValue->page_title;?></a>
                               <?php if(!empty($datasubsub))
                               {?>
                                <ul>
                                <?php foreach($datasubsub as $datasubsubval){?>
                                 <li><a href="<?php echo main_base_url;?>/hindi/<?php echo $datasubsubval->slug;?>"><?php echo $datasubsubval->page_title;?></a></li>
                              <?php   } ?>
                                </ul>
                             <?php   }  ?>
